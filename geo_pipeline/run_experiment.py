...
ENV_KEYS = (
    ...
    "COUNTRY_GEOREASONER_SEED",
    "GEOREASONER_COUNTRY_BOOST",
    "GEOREASONER_REQUIRE_DIRECT_CLUE",
    "CITY_COUNTRY_FACTCHECK",
    "CITY_COUNTRY_FACTCHECK_MIN_COUNTRY_TOP",
    ...
    "RETRIEVAL_VERIFY_ACTION_ENABLED",
    "RETRIEVAL_VERIFY_MIN_PRIOR_TOP",
    "RETRIEVAL_VERIFY_RELATIONS",
    "RETRIEVAL_VERIFY_TOP_K",
...
def main() -> int:
    ...
    if args.retrieval_country_fallback:
        ...
        if args.retrieval_country_same_continent_max_country_top is not None:
            cmd += [
                "--retrieval_country_same_continent_max_country_top",
                str(args.retrieval_country_same_continent_max_country_top),
            ]
        if args.retrieval_country_cross_continent_max_country_top is not None:
            cmd += [
        ...
        if args.retrieval_country_child_retry_relations:
            cmd.append("--retrieval_country_child_retry_relations")
            cmd += list(args.retrieval_country_child_retry_relations)
